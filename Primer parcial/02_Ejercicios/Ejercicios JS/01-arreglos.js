...
console.log("Aplicando un map con solo nombres");
const nombre = talleres.map((t) => t.nombre);
console.log(nombre);
...
console.log("Aplicando la funcion find para buscar un instructor");
...
console.log("Aplicando filter y map para buscar talleres disponibles");
